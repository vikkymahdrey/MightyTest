	...
	<div class="content-wrapper">
			...
			<section class="content">
		 		<div class="content-wrap box box-primary">
						...
						<!-- <div class="row ">
								<div class="col-sm-4 text-bold " style="margin-left: 33.5%;">
									<div class="alert alert-danger san " hidden="hidden"	style="color: red;">
										<p id="errortag" ></p>
									</div>
								</div>
						</div> -->
					    ...
					    <form action="deviceFirmwareSubmit" enctype="multipart/form-data" name="deviceFirmwareForm" 
								...
								<div class="push-200 login-input-wrap">
									...
									<div class="col-sm-12">
										<input class="btn btn-primary text-bold fa fa-upload" type="submit" value="Upload" />
									</div>
