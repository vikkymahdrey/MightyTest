    ...
    <section class="sidebar">
      ...
      <form action="#"  class="sidebar-form">
        <div class="input-group">
          <input type="text" name="dev" id="devId2" class="form-control" placeholder="Search by mighty...">
              <span class="input-group-btn">
                <button type="button" name="search" id="search-btn" class="btn btn-flat" onclick="getDevId(this.form.devId2.value)"><i class="fa fa-search"></i>
                </button>
              </span>
        </div>
      </form>
