...
<title>Mighty Downloading Audit log</title>
...
<body class="hold-transition skin-blue sidebar-mini">
						<% AdminUser adminUser=(AdminUser)request.getSession().getAttribute("adminUser");
											String fname1=("MightyDownloadingAuditlog :").concat(new Date().toString()).concat(".csv");
											String fname2=("MightyDownloadingAuditlog :").concat(new Date().toString()).concat(".xls");
											String fname3=("MightyDownloadingAuditlog :").concat(new Date().toString()).concat(".xml");
					 	   List<Mightydlauditlog> mightydlauditlog=(List<Mightydlauditlog>)request.getAttribute("mightydlauditlog");
						%>
			...
			<section class="content ">
		 		<div class="content-wrap box box-primary">
						...
						<div class="row">
								...
								<h5 class="text-blue text-semi-bold"><i class="fa fa-download"></i>&nbsp;&nbsp;<b>Mighty Downloading Audit log</b></h5>
								</div>
						...
						<div class="row" style="overflow-y: auto;">
							...
							<%-- <table class="table table-hover text-center">
								...
								<%if(mightydlauditlog!=null && !mightydlauditlog.isEmpty()){ %>	  
						
				        <display:table class="table table-hover text-center" name="<%=mightydlauditlog%>" id="row"
									export="true" requestURI="" defaultsort="1" defaultorder="descending" pagesize="50">
								<display:column  property="id" title="ID" sortable="true" headerClass="sortable" />
											
								<display:column  property="deviceId" title="MightyHwSerialNo."	sortable="true" headerClass="sortable" />
								
								<display:column  property="app_OS" title="AppOS" sortable="true" headerClass="sortable"/>
								
								<display:column  property="appVer" title="AppVer" sortable="true" headerClass="sortable"/>
								
								<display:column  property="bleStatus" title="Ble_Status"	sortable="true" headerClass="sortable" />
								
								<display:column  property="wifiStatus" title="Wifi_Status"	sortable="true" headerClass="sortable" />
								
								<display:column  property="internetConn" title="InternetConn"	sortable="true" headerClass="sortable" />
																
								<display:column  property="downloadPerc" title="Download_%" 	sortable="true" headerClass="sortable" />
								
								<display:column  property="downloadCurrVer" title="DownloadCurrVer" sortable="true" headerClass="sortable"/>
								
								<display:column  property="errorCode" title="ErrorCode" sortable="true" headerClass="sortable"/>
